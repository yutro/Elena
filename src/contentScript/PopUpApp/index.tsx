...
export const PopUpApp = () => {
    ...
    return <div ref={refNode} className="absolute mt-5 ml-4">{isActive ?
        <DataContext.Provider value={{text, displayPopUp: (val: boolean) => displayActions.setValue(val)} }><ModalWindow/></DataContext.Provider> : null}</div>
}
